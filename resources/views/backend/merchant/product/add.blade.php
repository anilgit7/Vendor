<div id="add-product" class="fixed top-0 right-0 z-[10000] w-full h-screen max-w-[13rem] 2xs:max-w-[15rem] sm:max-w-[17rem] lg:max-w-xs p-4 overflow-y-auto transition-transform translate-x-full bg-white shadow-[-5px_-1px_5px_-8px_rgba(0,0,0,0.75)]" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
    ...
    <form id="form_add_product" action="{{route('product.add')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="space-y-4">
            ...
            <div>
                <label for="product_name" class="block mb-2 text-sm font-medium text-gray-900">Product Name <abbr title="required">*</abbr></label>
            ...
            <div>
                <label for="product_price" class="block mb-2 text-sm font-medium text-gray-900">Product Price <abbr title="required">*</abbr></label>
            ...
            <div>
                <label for="product_category" class="block mb-2 text-sm font-medium text-gray-900">Category <abbr title="required">*</abbr></label>
            ...
            <div>
                <label for="product_color" class="block mb-2 text-sm font-medium text-gray-900">Product Color <abbr title="required">*</abbr></label>
            ...
            <div>
                <label for="product_size" class="block mb-2 text-sm font-medium text-gray-900">Size Available <abbr title="required">*</abbr></label>
                <div id="checkbtn"class="flex items-center space-x-4">
                    <label for="size_1" class="block mb-2 text-sm font-medium text-gray-900"><input type="checkbox" id="size_1" class="w-4 h-4 rounded-full focus:ring-0 mr-1 mb-1 text-sm font-medium text-gray-900" name="o1" value="S" checked>S</label>
                    <label for="size_2" class="block mb-2 text-sm font-medium text-gray-900"><input type="checkbox" id="size_2" class="w-4 h-4 rounded-full focus:ring-0 mr-1 mb-1 text-sm font-medium text-gray-900" name="o2" value="L" >L</label>
                    <label for="size_3" class="block mb-2 text-sm font-medium text-gray-900"><input type="checkbox" id="size_3" class="w-4 h-4 rounded-full focus:ring-0 mr-1 mb-1 text-sm font-medium text-gray-900" name="o3" value="XL" >XL</label>
                    <label for="size_4" class="block mb-2 text-sm font-medium text-gray-900"><input type="checkbox" id="size_4" class="w-4 h-4 rounded-full focus:ring-0 mr-1 mb-1 text-sm font-medium text-gray-900" name="o4" value="XXL" >XXL</label>
                </div>
            </div>
            <div class="w-full max-w-[13rem] 2xs:max-w-[15rem] sm:max-w-[17rem] lg:max-w-xs">
                ...
                <input type="file" name="image" class="w-full rounded-lg bg-gray-50 border border-gray-300 text-gray-500 text-sm focus:ring-primary-600 focus:border-primary-600 p-2">
            </div>

            <div class="w-full max-w-[13rem] 2xs:max-w-[15rem] sm:max-w-[17rem] lg:max-w-xs">
                <label for="product_material" class="block mb-2 text-sm font-medium text-gray-900">Product Material <abbr title="required">*</abbr></label>
            ...
            <div class="w-full max-w-[13rem] 2xs:max-w-[15rem] sm:max-w-[17rem] lg:max-w-xs">
                <label for="product_weight" class="block mb-2 text-sm font-medium text-gray-900">Weight <abbr title="required">*</abbr></label>
