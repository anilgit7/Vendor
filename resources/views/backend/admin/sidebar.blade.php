    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-900">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="dropdown-merchant" class="space-y-2 py-2 {{ ((Route::currentRouteName() === 'admin.merchant.list')) ? '' : 'hidden' }}">
                    <li>
                        <a href="{{ route('admin.merchant.list') }}" class="text-base text-gray-300 rounded-lg flex items-center p-1 2xs:p-2 group hover:bg-gray-100 transition duration-75 pl-5 2xs:pl-11 {{ (Route::currentRouteName() === 'admin.merchant.list') ? 'bg-[#F3F4F6] text-gray-900' : '' }}">
                    ...
                    <li>
                        <a href="#" class="text-base text-gray-300 rounded-lg flex items-center p-1 2xs:p-2 group hover:bg-gray-100 transition duration-75 pl-5 2xs:pl-11">
                            <svg class="flex-shrink-0 w-3 h-3 2xs:w-6 2xs:h-6 text-gray-500 transition duration-75 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <li>
                ...
                <ul id="dropdown-customers" class="space-y-2 py-2 {{ ((Route::currentRouteName() === 'admin.customer.list')) ? '' : 'hidden' }}">
                    <li>
                        <a href="{{ route('admin.customer.list') }}" class="text-base text-gray-300 rounded-lg flex items-center p-1 2xs:p-2 group hover:bg-gray-100 transition duration-75 pl-5 2xs:pl-11 {{ (Route::currentRouteName() === 'admin.customer.list') ? 'bg-[#F3F4F6] text-gray-900' : '' }}">
