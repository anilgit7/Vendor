                ...
                <div class="flex sm:grid grid-cols-12 lg:grid-cols-12 xl:grid-cols-9 gap-[1rem] items-center">
                    ...
                    <div class="col-span-2 md:col-span-4 lg:col-span-3 xl:col-span-2 ml-auto">
                        <div class="flex space-x-[1rem] md:space-x-[2rem] items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="dropdown-nav-menu bg-[#F28C28] shadow-[0px_0px_1px_1px_rgba(0,0,0,0.25)] z-[1000] hidden py-1.5 rounded-md w-max max-w-[100px] pl-2" id="dropdownProfileSetting">
                                            ...
                                            <div class="max-[280px]:px-1 max-[280px]:py-1 px-2 py-2 dark:text-white truncate">
                                                <a href="{{ route('user.dashboard') }}" class="max-[280px]:text-[.7rem] max-sm:text-[.9rem] font-semibold pb-1 text-gray-900 hover:border-y-2 rounded-[.3rem]">
                                                    {{ __('Profile') }}
                                                </a>
                                            </div>
                                            <div class="max-[280px]:px-1 max-[280px]:py-1 px-2 py-2 dark:text-white truncate">
                            ...
                            <a href="{{ route('cart.index')}}" class="relative group" id="header-cart">
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cart-shopping" class="h-6 w-6 text-[#212529]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                    <path fill="currentColor" d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"></path>
                                </svg>
                                @if(Cart::count()>0)
                                    <span class="text-[.6rem] absolute top-[-6px] right-[-5px] w-[15px] h-[15px] text-black rounded-[50%] bg-white group-hover:bg-black group-hover:text-white text-center">
                                        <span class="drop-shadow-[0px_0px_.5px_#000000] group-hover:drop-shadow-[0px_0px_.5px_#ffffff]">{{Cart::count()}}</span>
                                    </span>
                                @endif
                            </a>
                        </div>
